...
// Render count tracking for debugging infinite loops
...
const SelectTrigger = React.memo(({ className, children, ...props }) => {
  // Track renders for debugging infinite loops
  React.useLayoutEffect(() => {
    if (process.env.NODE_ENV !== "production") {
      if (renderCount.current > 1) {
        console.warn(
          "Select: detected multiple renders before layout effect — a parent may be updating state during render. Avoid calling setState in render or component render paths.",
        );
      }
    }
