    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-xl shadow-blue-50/50 border border-slate-100 p-10">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-black text-slate-800 mb-2">Bon retour</h1>
          <p className="text-sm text-slate-500 font-medium">Connectez-vous pour gérer vos projets</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center ml-1">
              ...
              <button type="button" className="text-[10px] font-bold text-blue-600 hover:underline">Oublié ?</button>
            </div>
            <div className="relative group">
        ...
        <p className="text-center mt-8 text-xs text-slate-500 font-medium">
          Vous n'avez pas de compte ? <button className="text-blue-600 font-bold hover:underline">Contactez l'administration</button>
        </p>
      </div>
    </div>
  );
