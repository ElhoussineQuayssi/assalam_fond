  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-slate-400">Contact Messages Management</h2>
                  ...
                  <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-600">
                    {(Array.isArray(messages) ? messages : []).map((message) => {
                      ...
                      if (typeof window !== 'undefined' && process.env.NODE_ENV === 'development') {
                        ...
                        console.log('Message subject type:', typeof message?.subject);
                      }
                      
                      return (
                      <tr key={message.id || message.email || Math.random()} className="hover:bg-gray-50 dark:hover:bg-slate-700">
                        ...
                        <td className="px-6 py-4 text-sm text-gray-500 dark:text-slate-300">
                          <div className="max-w-xs truncate" title={getMessageSubject(message)}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex space-x-2">
                            ...
                            <Button 
                              ...
                              onClick={() => onDelete(message?.id || message?.email || Math.random())}
