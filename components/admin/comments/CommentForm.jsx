        ...
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="comment-author-name" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">
                  Author Name *
                </label>
                <Input
              ...
              <div>
                <label htmlFor="comment-author-email" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">
                  Author Email *
                </label>
                <Input
            ...
            <div>
              <label htmlFor="comment-content" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">
                Comment Content *
              </label>
              <Textarea
                id="comment-content"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="comment-post-id" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">
                  Related Post ID
                </label>
                <Input
                  id="comment-post-id"
              ...
              <div>
                <label htmlFor="comment-status" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">
                  Status
                </label>
