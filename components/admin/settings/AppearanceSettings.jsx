      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Select defaultValue="light">
            <SelectTrigger className={`w-48 ${isDarkMode ? 'bg-slate-700 border-slate-600 text-white' : ''}`}>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="flex items-center justify-between">
          <div>
            <label className={`text-sm font-medium ${isDarkMode ? 'text-slate-400' : 'text-gray-700'}`}>
              Show Sidebar
            </label>
