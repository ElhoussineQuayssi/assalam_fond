      ...
      <Card className={`${isDarkMode ? 'bg-slate-700 border-slate-600' : 'bg-gray-50 border-gray-200'}`}>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            />
            {!content.heading && (
              <p className="text-xs text-yellow-600 mt-1">Heading is recommended</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {!content.text && (
              <p className="text-xs text-yellow-600 mt-1">Content is required</p>
            )}
          </div>
          ...
          {showPreview && (
            <div className={`p-4 rounded-lg border ${
              isDarkMode ? 'bg-slate-800 border-slate-500' : 'bg-white border-gray-200'
            }`}>
