import { getProjectById, updateProject, deleteProject, validateProjectData } from '@/controllers/projectsController';
...
export async function PUT(request, { params }) {
  try {
    ...
    const processedData = {
      ...
      categories: Array.isArray(requestData.categories) ? requestData.categories : [],
    ...
    console.error('Server error:', error);
    return errorResponse(`Update failed: ${error.message}`, 500, { originalError: error.message });
  }
}
